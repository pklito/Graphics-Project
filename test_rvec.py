...
trans = [[[-1.97, 0.59, -1.67], [-1.07, 1.24, 3.16]], [[-1.24, -1.62, -1.58], [-1.29, -0.99, 4.24]], [[-2.58, -0.03, 0.16], [0.02, 0.36, 5.75]], [[1.56, -0.95, 0.18], [4.99, 0.93, 6.05]], [[2.18, 0.2, -0.4], [-0.98, 1.25, 3.05]], [[-0.22, -1.91, 0.05], [-0.01, 0.05, 3.42]], [[-1.89, -1.89, -0.38], [-0.99, -0.08, 3.57]], [[1.55, -1.05, 0.28], [3.81, 0.94, 6.2]]]
rvec = trans[0][0]
print(rvec)
